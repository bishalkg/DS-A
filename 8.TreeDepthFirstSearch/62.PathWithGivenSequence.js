...
const isValidSequence = function(currNode, sequence, seqIndex) {
  ...
  if (!currNode.left && !currNode.right && seqIndex === seqLen-1) { //this means the current value is the value at the current seq index and if we are at the last index of the sequence and we are at a leaf node
    return true;
  }
